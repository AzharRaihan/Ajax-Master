  ...
  <section class="py-5">
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-md-8">
          <h3 class="pb-5 text-center">Country</h3>
          <!-- Button trigger modal -->
          <button type="button" class="btn btn-primary mb-2" data-bs-toggle="modal" data-bs-target="#addModal">
            Add New
          </button>
          <a href="{{ route('state.create') }}" class="btn btn-info mb-2">State Create</a>
          <div id="message"></div>
        ...
        <div class="modal-body">
          ...
          <form action="">
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="editname" placeholder="Country Name">
            </div>
          </form>
        </div>
        <div class="modal-footer">
      ...
      $.ajax({
        ...
        success: function (response) {
          if(status == 404){
            ...
            $('#editname').val(response.editId.country_name);
